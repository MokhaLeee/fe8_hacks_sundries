...
def main(args):
    for line in sys.stdin.readlines():
        ...
        if line.find("GFX_CombatArtIcon") != -1:
            ...
            continue
        elif line.find("battle_terrain_") != -1:
            continue
        elif line.find("Changes_change_") != -1:
            continue
        elif line.find("ItemList_") != -1:
            continue
        elif line.find("EventScrWM_") != -1:
            continue
        elif line.find("Sprite_") != -1:
            continue
        elif line.find("TileAnimations") != -1:
            continue
        elif line.find("TerrainTable_") != -1:
            continue
        elif line.find("btl_bg_") != -1:
            continue
